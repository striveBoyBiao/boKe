...
<div class="about">
    <ul>
        ...
        <div class="about_girl"><span><a href="/"><img src="${pageContext.request.contextPath}/images/girl.jpg"></a></span>
            <p>初遇时，他的幽默，他往日的深情、承诺和傻劲儿，两个人共度的美丽时刻，一一印在我的回忆里....</p>
        </div>
        <div class="about_boy"><span><a href="/"><img src="${pageContext.request.contextPath}/images/boy.jpg"></a></span>
