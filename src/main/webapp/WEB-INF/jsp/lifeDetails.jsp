...
<article class="blogs">
                            ...
                            <div node-type="block-head-w" class="block-head-w">
                                <div node-type="avatar" class="head-img-w">
                                    <a href="javascript:void(0);">
                                        <img node-type="user-head" src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/pic42_null.gif" width="42" height="42" alt="">
                                                ...
                                                <div node-type="uploading-wrapper" class="uploading-wrapper-dw uploading-efw ">
                                                    ...
                                                    <div node-type="image-uploaded" class="wrapper-image-dw">
                                                        ...
                                                        <div class="image-pic-dw">
                                                            <img node-type="image-pic" alt="" src="http://www.yangqq.com/news/s/2013-10-21/616.html">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    -->
                ...
                <div node-type="module-cmt-list" class="module-cmt-list section-list-w">
                    ...
                    <div class="cmt-list-type">
                        ...
                        <div class="cmt-list-number">
                            <span class="comment-number"><span class="cy-number">13</span>人参与,<span class="cy-number">13</span>条评论</span>
                        </div>
                    </div>
                    <!-- 最新评论 -->
                    <div class="list-block-gw list-newest-w">
                        ...
                        <div node-type="cmt-list" id="cy-cmt-list">
                            <div node-type="cmt-item" data-id="1407124515" data-user-id="0" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="杨青博客网友">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449555812815_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2016年8月25日 6:32</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">杨青博客网友</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">文章很好~！赞</span></p>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124514" data-user-id="0" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="杨青博客网友">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449555807065_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2016年8月15日 11:43</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">杨青博客网友</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">这个文章写的好，转走了！   http://www.xevip.cn</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124513" data-user-id="-1056194328" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="东元电机">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449556172180_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2016年8月12日 9:59</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">东元电机</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">楼主听话，快到碗里来！</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124512" data-user-id="-731460428" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="631675257">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449555781335_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2016年8月11日 20:01</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">631675257</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">还不错。。。各类教程软件下载（哈喽猫网）：www.haloumao.com</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124511" data-user-id="-1109018669" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="SB联盟">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449556058593_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2016年7月31日 13:46</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">SB联盟</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">sdfsdgd当下流行的婚纱照风 stone-gy.com</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124510" data-user-id="-1078755033" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="振动筛">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449556072985_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2016年7月27日 18:00</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">振动筛</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">祝福博主</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124509" data-user-id="-1154414234" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="金鹤">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449555807065_jpg(1)" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2013年11月7日 12:52</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">金鹤</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">博主 祝你的婚后生活幸福美满.</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124508" data-user-id="-538340119" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="职场博客">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449555978993_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2013年10月30日 13:34</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">职场博客</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">博主幸福哈  结婚以后就有伴了</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124507" data-user-id="-1125815931" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="Viiguo微果网">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449556184057_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2013年10月29日 15:35</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">Viiguo微果网</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">祝福啊！~ 平淡就好</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124506" data-user-id="-1123819748" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="秦皇岛农民网络工作室">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449555781335_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2013年10月27日 16:25</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">秦皇岛农民网络工作室</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">呵呵！还真能够看透生活的啊！</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124505" data-user-id="0" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="杨青博客网友">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449555771861_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2013年10月26日 13:27</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">杨青博客网友</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">祝福.</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124504" data-user-id="0" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="杨青博客网友">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449555769139_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2013年10月24日 23:16</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">杨青博客网友</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">恭喜恭喜</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;"><i class="icon-gw icon-cai-bg"></i><em class="icon-name-bg"></em></a>
                            ...
                            <div node-type="cmt-item" data-id="1407124503" data-user-id="-594651026" data-platform-id="0" class="clear-g block-cont-gw">
                                <div class="cont-head-gw">
                                    <div class="head-img-gw">
                                        <a node-type="photo" href="javascript:;" title="蓝辰">
                                            <div class="img-corner"></div>
                                            <img src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/fac494264beff70ed91fedf32783552b_default_1449556044820_jpg" width="42" height="42" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="cont-msg-gw">
                                    <div class="msg-wrap-gw">
                                        <div class="wrap-user-gw global-clear-spacing">
                                            <span class="user-time-gw">2013年10月24日 13:07</span>
                                            <span node-type="nickname" class="user-name-gw"><a href="javascript:void(0)">蓝辰</a></span>
                                        </div>

                                        <div class="wrap-issue-gw">
                                            <p class="issue-wrap-gw"><span class="wrap-word-gw">平淡是福</span></p>
                                            <div class="cy-see-more">
                                                <span></span><i></i>
                                            </div>
                                        </div>
        ...
        <%--<script charset="utf-8" type="text/javascript" src="./慢生活- 柴米油盐的生活才是真实 - 一个站在web前端设计之路的女技术员个人博客网站_files/changyan.js.下载"></script>--%>
    ...
    <aside class="right">
        ...
        <div class="rnav">
            ...
            <ul>
                ...
                <li>
                    <a href="http://www.yangqq.com/news/s/">日记</a>
                </li>

                <li>
                    <a href="http://www.yangqq.com/news/read/">欣赏</a>
                </li>

                <li>
                    <a href="http://www.yangqq.com/news/life/">程序人生</a>
                </li>

                <li>
                    <a href="http://www.yangqq.com/news/humor/">经典语录</a>
                </li>
            </ul>
        </div>
        <div class="rnavs">
