...
<article class="blogs">
    ...
    <div class="index_about">
        ...
        <p class="box_c"><span class="d_time">发布时间：${list.gtmcreate}</span><span>编辑：<a href="mailto:1169763240@qq.com">${list.author}</a></span><span>阅读（<script src="./${list.title} - 一个站在web前端设计之路的男技术员个人博客网站_files/saved_resource"></script>3604）</span></p>
        <ul class="infos">
