...
<article class="blogs">
    <h1 class="t_nav"><span>您当前的位置：<a href="/main/main.do">首页</a>&nbsp;&gt;&nbsp;<a href="/main/share.do">模板分享
    ...
    <div class="index_about">
        ...
        <p class="box_c"><span class="d_time">发布时间：${list.gtmcreate}</span><span>编辑：<a href="mailto:1169763240@qq.com">${list.author}</a></span><span>阅读（<script src="./${list.title} - 一个站在web前端设计之路的男技术员个人博客网站_files/saved_resource"></script>${list.reading}）</span></p>
        <ul class="infos">
            ${list.content}
        ...
        <div class="nextinfo">
            <p>上一篇：
                <a href='/main/findShareDetails.do?cid=${ondate.cid}' title='${ondate.title}' >${ondate.title}</a>
            </p>
            <p>下一篇：
                <a href='/main/findShareDetails.do?cid=${underDate.cid}' title='${underDate.title}' >${underDate.title}</a>
            </p>
        </div>
        <div class="otherlink">
            <h2>相关文章</h2>
            <ul>
                <c:forEach items="${relatedate}" var="relate" >
                    <li>
                        <a href='/main/findShareDetails.do?cid=${rank.cid}' title='${relate.title}' >${relate.title}</a>
                    </li>
                </c:forEach>
            </ul>
        </div>
    ...
    <aside class="right">
        <div class="rnav">
            ...
            <ul>
                ...
                <li>
                    <a href="/main/share.do">个人博客模板</a>
                </li>

                <li>
                    <a href="/main/share.do">国外html5模板</a>
                </li>

                <li>
                    <a href="/main/share.do">企业网站模板</a>
                </li>

                <li>
                    <a href="/main/share.do">作品展示</a>
                </li>
            </ul>
        </div>
        <div class="rnavs">
        ...
        <div class="news">
            ...
            <ul class="rank" id="lifedetailsnewsdate">
                  <c:forEach items="${newsdate}" var="news" >
                        <li>
                            <a href='/main/findShareDetails.do?cid=${news.cid}' title='${news.title}' >${news.title}</a>
                        </li>
                  </c:forEach>
            </ul>
            <h3 class="ph">
            ...
            <ul class="paih" id="lifedetailsrankdate">
                <c:forEach items="${rankdate}" var="rank" >
                    <li>
                        <a href='/main/findShareDetails.do?cid=${rank.cid}' title='${rank.title}' >${rank.title}</a>
                    </li>
                </c:forEach>
            </ul>
        </div>
