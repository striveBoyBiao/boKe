...
function ckstyle() { //定义总的风格
	...
	ck.setup = '1,1,1,1,1,1,0,1,1,3,4';
    ...
    ck.pm_ctbar = '1,2,140,-50,140,30,0,2,5000';
    ...
    ck.pm_sch = '0,2,250,-37,270,6,0,10,10';
    //进度条的参数，这里分二种情况，前面7个参数对照控制栏的，第8个参数是拖动按钮的宽，第9个参数是拖动按钮的高
    ck.pm_play = '0,2,100,-50';
    //播放和暂停按钮的坐标
    ck.pm_clock = '0,2,46,-45,120';
    //已播放时间的坐标和宽度
    ck.pm_clock2 = '0,2,155,-45,120';
    //总时间的坐标和宽度
    ck.pm_full = '2,2,-140,-50';
    //全屏和取消全屏按钮的坐标
    ck.pm_vol = '2,2,-210,-37,53,6,10,10';
    //音量调节框的坐标，宽度，高度，拖动按钮的宽度,高度
    ck.pm_sound = '2,2,-255,-50';
    //静音和取消静音的坐标
    ck.pm_fastf = '2,2,-182,-30';
    //快进按钮的坐标
    ck.pm_fastr = '0,2,125,-30';
    //快退按钮的坐标
    ck.pm_fasttime = '10';
    //快进和快退的秒数
    ck.pm_video_bottom = '0,35';
    ...
    ck.pr_clock2 = '{font color="#ffffff" size="14"}[$Time] | [$TimeAll]{/font}';
