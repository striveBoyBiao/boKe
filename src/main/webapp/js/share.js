    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $.each(data.pageDate,function(index,element){
                ...
                resultHtml+="<p class='dateview'><span>发布时间："+element.gtmcreate+"</span><span>作者："+element.author+"</span><span>[<a href='/main/findShareDetails.do?cid="+element.cid+"'>"+element.typename+"</a>]</span></p>";
                resultHtml+="<figure><a title='"+element.title+"' href='/main/findShareDetails.do?cid="+element.cid+"'><img src='"+element.titlepicture+"' alt='"+element.title+"'></a></figure>";
                resultHtml+="<ul class='nlist'><p>"+element.introduction+"</p><a href='/main/findShareDetails.do?cid="+element.cid+"' title='"+element.title+"' class='readmore'>阅读全文&gt;&gt;</a>";
